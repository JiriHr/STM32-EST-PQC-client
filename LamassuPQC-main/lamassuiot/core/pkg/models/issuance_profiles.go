...
type IssuanceProfileCryptoEnforcement struct {
	...
	AllowDilithiumKeys           bool  `json:"allow_dilithium_keys"`
	AllowedDilithiumModes        []int `json:"allowed_dilithium_modes" gorm:"type:text;serializer:json"`
	AllowMLDSAKeys               bool  `json:"allow_mldsa_keys"`
	AllowedMLDSASecurityVersions []int `json:"allowed_mldsa_security_versions" gorm:"type:text;serializer:json"`
}
