...
type CreateIssuanceProfileCryptoEnforcementBody struct {
	...
	AllowedDilithiumModes        []int `json:"allowed_dilithium_modes"`
	AllowMLDSAKeys               bool  `json:"allow_mldsa_keys"`
	AllowedMLDSASecurityVersions []int `json:"allowed_mldsa_security_versions"`
}
